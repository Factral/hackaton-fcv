...
export default function Auth () {
  return (
    <div className='h-screen w-screen bg-gradient-to-tr from-main-white-100 to-main-white-200 md:grid'>
      <div className='h-screen w-screen bg-gradient-to-t to-gradient-green-100 from-gradient-green-200 grid place-items-center md:w-full md:max-w-5xl md:h-fit md:py-10 max-h-[90vh] rounded-xl md:shadow-xl m-auto'>
